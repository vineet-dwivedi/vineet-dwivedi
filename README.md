...
const vineet = {
  ...
  focus: "Building production-grade AI-powered applications",

  currentWork: {
    company: "Flowaris Technologies",
    role: "SDE Intern",
    building: [
      "AI agents using LangChain",
      "Real-time systems with LiveKit",
      "Scalable backend architectures"
    ]
  },

  impact: [
    "Built Perplexity-style AI search engine",
    "Developed multiple full-stack production apps",
    "Focused on real-world problem solving with AI"
  ],

  learning: ["System Design", "Microservices", "Advanced AI Patterns"]
};
```

> 💡 *"I don't just integrate AI — I build systems around it."*
...
<div align="center">
  <img width="48%" src="https://github-readme-stats.vercel.app/api?username=vineet-dwivedi&show_icons=true&theme=tokyonight&hide_border=true" />
  <img width="48%" src="https://github-readme-streak-stats.herokuapp.com/?user=vineet-dwivedi&theme=tokyonight&hide_border=true" />
</div>
